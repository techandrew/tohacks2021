...
import 'equal.dart';
import 'ai/ai.dart';
import 'package:muggles/screens/game/ai/EasyAI.dart';
          ...
          child: Opacity(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text(
                  (winner == GameState.Blank) ? "It's a draw!" : 'wins!',
                  style: TextStyle(
                    fontWeight: FontWeight.w600,
                    color: winner==GameState.O?Color(primaryColor):Color(secondaryColor),
                    fontFamily: 'Poppins',
                    fontSize: 56.0,
                  ),
                ),
